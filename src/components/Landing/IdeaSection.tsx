...
const InvestmentPlatformSection = () => {
    ...
    return (
        <div className="relative bg-black text-white p-4 sm:p-8 lg:p-24">
            <div className="absolute inset-0 mx-4 sm:mx-6 md:mx-10 my-6 sm:my-8 md:my-10 bg-white/10 opacity-50 rounded-xl"></div>
            <img
                src="./imageIdeas.png"
                alt="Head Background"
                className="absolute -right-32 md:-right-60 top-0 h-full object-contain opacity-60 md:opacity-100 pointer-events-none hidden sm:block"
            />
            <div className="mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 mt-6 sm:mt-10 p-4 sm:p-10 z-30">

                {/* Column 1 - The Idea */}
                <div className="flex flex-col justify-between">
                    <div>
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light mb-4">The Idea:</h2>
                        <h3 className="text-2xl sm:text-3xl lg:text-5xl text-gray-400 mb-6 font-light flex flex-col space-y-1 sm:space-y-3">
                            <span>From Broad </span><span>Themes to Hidden</span><span>Gems</span>
                        </h3>
                    </div>
                    <p className="text-gray-300 text-base sm:text-xl lg:text-2xl leading-relaxed pr-0 sm:pr-8 lg:pr-20">
                        Move beyond generic stock screeners. Our AI-powered Idea Engine is
                        designed to systematically uncover high-potential investment
                        opportunities that others miss. We analyze millions of data points
                        to deliver ideas rooted in solid fundamentals and forward-looking
                ...
                <div className="space-y-6 sm:space-y-10">
                    <div>
                        <h3 className="text-xl sm:text-2xl lg:text-3xl font-light text-green-400 mb-3">
                            Deep Fundamental Screening
                        </h3>
                ...
                {/* Column 3 - SVG + CTA */}
                <div className="flex flex-col justify-center items-center text-center z-10">
                    <div ref={headlineRef} className="keen-slider flex-1 mb-6">
                        <div className="keen-slider__slide text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-light leading-tight">
                            Invest in Fortresses
                        </div>
                        <div className="keen-slider__slide text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-light leading-tight">
                            Stay Ahead of the Curve
                    ...
                    <div
                        ref={iconRef}
                        className="keen-slider w-24 h-24 sm:w-32 sm:h-32 lg:w-40 lg:h-40 mb-6"
                    >
                        <img src="./mission 1.png" className="keen-slider__slide object-contain" />
                        <img src="./value 1.png" className="keen-slider__slide object-contain" />
                        <img src="./award-symbol 1.png" className="keen-slider__slide object-contain" />
                    ...
                    <div className="mt-6">
                        <button className="text-green-400 hover:text-green-300 text-2xl sm:text-3xl lg:text-4xl font-light underline flex items-center gap-2 transition-colors group">
                            Explore Ideas
                            <svg
